...
#define FIRMWARE_VERSION_CODE  "ESP32S3-Geek-v15.2.0"
...
// -- OTA --
#undef OTA_URL
#define OTA_URL                "https://github.com/HaraldKiessling/tasmota-ESP32S3-Geek/raw/main/firmware/tasmota32s3-lvgl-15.2.0.bin"
...
// Note: USE_SCRIPT conflicts with USE_RULES, only one can be enabled
